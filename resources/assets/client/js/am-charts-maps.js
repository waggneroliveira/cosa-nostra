    ...
    QJ7E: function(t, e, n) {
        ...
        var S = function() {
            ...
            return function(t, e, n) {
                ...
                key: "valueOf",
                value: function() {
                    var t, e, n, i = this._partials, r = this._n, o = 0;
                    if (r > 0) {
                        for (o = i[--r]; r > 0 && (t = o,
                        !(n = (e = i[--r]) - ((o = t + e) - t))); )
                            ;
        ...
        var at, ut, st, ct, lt, ht = function(t, e) {
            ...
            polygonEnd: function() {
                var t = +pt;
                ft.add(t < 0 ? N + t : t),
                this.lineStart = this.lineEnd = this.point = tt
            },
            sphere: function() {
                ft.add(N)
            }
        ...
        var At = {
            ...
            polygonEnd: function() {
                ...
                At.lineEnd = Bt,
                pt < 0 ? (bt = -(_t = 180),
                Pt = -(St = 90)) : Ot > E ? St = 90 : Ot < -E && (Pt = -90),
                Ct[0] = bt,
                Ct[1] = _t
            },
            sphere: function() {
        ...
        function kt(t, e) {
            ...
            if (wt) {
                ...
                Vt(r),
                r = It(r);
                var o, a = t - Mt, u = a > 0 ? 1 : -1, s = r[0] * z * u, c = A(a) > 180;
                c ^ (u * Mt < s && s < u * t) ? (o = r[1] * z) > St && (St = o) : c ^ (u * Mt < (s = (s + 360) % 360 - 180) && s < u * t) ? (o = -r[1] * z) < Pt && (Pt = o) : (e < Pt && (Pt = e),
                e > St && (St = e)),
                c ? t < Mt ? qt(bt, t) > qt(bt, _t) && (_t = t) : qt(t, _t) > qt(bt, _t) && (bt = t) : _t >= bt ? (t < bt && (bt = t),
                t > _t && (_t = t)) : t > Mt ? qt(bt, t) > qt(bt, _t) && (_t = t) : qt(t, _t) > qt(bt, _t) && (bt = t)
            } else
                Lt.push(Ct = [bt = t, _t = t]);
            e < Pt && (Pt = e),
            e > St && (St = e),
        ...
        var Ut, Jt, Kt, Qt, $t, te, ee, ne, ie, re, oe, ae, ue, se, ce, le, he = function(t) {
            ...
            n = Lt.length) {
                ...
                e = 1,
                o = [i = Lt[0]]; e < n; ++e)
                    Yt(i, (r = Lt[e])[0]) || Yt(i, r[1]) ? (qt(i[0], r[1]) > qt(i[0], i[1]) && (i[1] = r[1]),
                    qt(r[0], i[1]) > qt(i[0], i[1]) && (i[0] = r[0])) : o.push(i = r);
                for (a = -1 / 0,
                e = 0,
                i = o[n = o.length - 1]; e <= n; i = r,
                ++e)
                    r = o[e],
                    (u = qt(i[1], r[0])) > a && (a = u,
                    bt = r[0],
            ...
            return Lt = Ct = null,
            bt === 1 / 0 || Pt === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[bt, Pt], [_t, St]]
        }, pe = {
            sphere: tt,
            point: fe,
            lineStart: ge,
        ...
        var Me = function(t) {
            ...
            n = Qt,
            i = $t),
            (r = W(e, n, i)) < I) ? [NaN, NaN] : [k(n, e) * z, Q(i / r) * z]
        }
          , xe = function(t) {
            return function() {
                return t
        ...
        var Ie = function(t) {
            function e(e) {
                return (e = t(e[0] * V, e[1] * V))[0] *= z,
                e[1] *= z,
                e
            }
            return t = Oe(t[0] * V, t[1] * V, t.length > 2 ? t[2] * V : 0),
            e.invert = function(e) {
                return (e = t.invert(e[0] * V, e[1] * V))[0] *= z,
                e[1] *= z,
                e
            }
            ,
        ...
        var De = function() {
            var t, e, n = xe([0, 0]), i = xe(90), r = xe(6), o = {
                point: function(n, i) {
                    t.push(n = e(n, i)),
                    n[0] *= z,
                    n[1] *= z
            ...
            return a.center = function(t) {
                return arguments.length ? (n = "function" == typeof t ? t : xe([+t[0], +t[1]]),
                a) : n
            }
            ,
            a.radius = function(t) {
                return arguments.length ? (i = "function" == typeof t ? t : xe(+t),
                a) : i
            }
            ,
            a.precision = function(t) {
                return arguments.length ? (r = "function" == typeof t ? t : xe(+t),
                a) : r
            }
            ,
            a
        ...
        var Ae = function(t, e, n, i, r) {
            ...
            if (t.forEach(function(t) {
                if (!((e = t.length - 1) <= 0)) {
                    ...
                    u.push(n = new Ve(i,t,null,!0)),
                    s.push(n.o = new Ve(i,null,n,!1)),
                    u.push(n = new Ve(a,t,null,!1)),
                    s.push(n.o = new Ve(a,null,n,!0))
                }
            }),
            u.length) {
                for (s.sort(e),
        ...
        var Fe = function(t, e) {
            ...
            for (var c = 0, l = t.length; c < l; ++c)
                if (p = (h = t[c]).length)
                    for (var h, p, f = h[p - 1], d = ke(f), g = f[1] / 2 + D, v = X(g), m = F(g), y = 0; y < p; ++y,
                    d = P,
                    v = M,
                    m = x,
                    f = b) {
          ...
          , Be = function(t, e, n, i) {
            return function(r) {
                var o, a, u, s = e(r), c = Ne(), l = e(c), h = !1, p = {
                    point: f,
                    lineStart: g,
                    lineEnd: v,
                    polygonStart: function() {
                    ...
                    polygonEnd: function() {
                        ...
                        a = L(a);
                        var t = Fe(o, i);
                        a.length ? (h || (r.polygonStart(),
                        h = !0),
                        Ae(a, We, t, n, r)) : t && (h || (r.polygonStart(),
                        h = !0),
                        r.lineStart(),
                        n(null, null, 1, r),
                        r.lineEnd()),
                ...
                function b() {
                    m(u[0][0], u[0][1]),
                    l.lineEnd();
                    var t, e, n, i, s = l.clean(), p = c.result(), f = p.length;
                    if (u.pop(),
                    o.push(u),
                    u = null,
                    f)
                        if (1 & s) {
                            ...
                            f > 1 && 2 & s && p.push(p.pop().concat(p.shift())),
                            a.push(p.filter(He))
                }
                return p
            }
        ...
        var Ze = Be(function() {
            ...
            return {
                ...
                point: function(o, a) {
                    var u = o > 0 ? T : -T
                      , s = A(o - n);
                    A(s - T) < E ? (t.point(n, i = (i + a) / 2 > 0 ? G : -G),
                    t.point(r, i),
                    t.lineEnd(),
                    t.lineStart(),
                    t.point(u, i),
                    t.point(o, i),
                    e = 0) : r !== u && s >= T && (A(n - r) < E && (n -= r * E),
                    A(o - u) < E && (o -= u * E),
                    i = function(t, e, n, i) {
                        var r, o, a = X(t - n);
        ...
        var qe = function(t) {
            ...
            function a(t, n, i) {
                ...
                if (!(v < 0)) {
                    ...
                    S = M,
                    M = b),
                    j || x < E ? j ? S + M > 0 ^ y[1] < (A(y[0] - P) < E ? S : M) : S <= y[1] && y[1] <= M : x > T ^ (P <= y[0] && y[0] <= _)) {
                        var w = zt(f, (-d + m) / g);
                        return Nt(w, p),
                        [y, It(w)]
                    }
            ...
            return Be(o, function(t) {
                ...
                return {
                    ...
                    point: function(h, p) {
                        var f, d = [h, p], g = o(h, p), v = i ? g ? 0 : u(h, p) : g ? u(h + (h < 0 ? T : -T), p) : 0;
                        if (!e && (c = s = g) && t.lineStart(),
                        g !== s && (!(f = a(e, d)) || ze(e, f) || ze(d, f)) && (d[2] = 1),
                        g !== s)
                            l = 0,
                            g ? (t.lineStart(),
                            f = a(d, e),
                            t.point(f[0], f[1])) : (f = a(e, d),
                            t.point(f[0], f[1], 2),
                            t.lineEnd()),
                            e = f;
                        else if (r && e && i ^ g) {
          ...
          , Xe = function(t, e, n, i, r, o) {
            var a, u = t[0], s = t[1], c = 0, l = 1, h = e[0] - u, p = e[1] - s;
            if (a = n - u,
            h || !(a > 0)) {
                if (a /= h,
                h < 0) {
        ...
        function Je(t, e, n, i) {
            ...
            return function(a) {
                var s, c, l, h, p, f, d, g, v, m, y, b = a, P = Ne(), _ = {
                    point: S,
                    lineStart: function() {
                        _.point = M,
                        c && c.push(l = []);
                    ...
                    polygonEnd: function() {
                        var e = function() {
                            for (var e = 0, n = 0, r = c.length; n < r; ++n)
                                for (var o, a, u = c[n], s = 1, l = u.length, h = u[0], p = h[0], f = h[1]; s < l; ++s)
                                    o = p,
                                    a = f,
                                    h = u[s],
                                    p = h[0],
                                    f = h[1],
                                    a <= i ? f > i && (p - o) * (i - a) > (f - a) * (t - o) && ++e : f <= i && (p - o) * (i - a) < (f - a) * (t - o) && --e;
                            return e
                        }()
                          , n = y && e
                          , r = (s = L(s)).length;
        ...
        var Ke, Qe, $e, tn, en = function() {
            var t, e, n, i = 0, r = 0, o = 960, a = 500;
            return n = {
                stream: function(n) {
                    return t && e === n ? t : t = Je(i, r, o, a)(e = n)
                },
                extent: function(u) {
                    return arguments.length ? (i = +u[0][0],
                    r = +u[0][1],
                    o = +u[1][0],
                    a = +u[1][1],
                    t = e = null,
        ...
        function gn(t, e) {
            for (var n, i, r, o = 0, a = t.length; o < a; o++) {
                if (0 === (i = ln(t[o], e)))
                    return !0;
                if (o > 0 && (r = ln(t[o], t[o - 1])) > 0 && n <= r && i <= r && (n + i - r) * (1 - Math.pow((n - i) / r, 2)) < I * r)
                    return !0;
                n = i
            }
            return !1
        ...
        function Sn() {
            var t, e, n, i, r, o, a, u, s, c, l, h, p = 10, f = p, d = 90, g = 360, v = 2.5;
            function m() {
                return {
            ...
            ,
            m.extentMajor([[-180, -90 + E], [180, 90 - E]]).extentMinor([[-180, -80 - E], [180, 80 + E]])
        }
        function Mn() {
            return Sn()()
        }
        var xn, jn, wn, On, Ln = function(t, e) {
            ...
            polygonEnd: function() {
                Tn.lineStart = Tn.lineEnd = Tn.point = tt,
                En.add(A(In)),
                In = new S
            },
            result: function() {
        ...
        var Bn, Hn, Wn, Zn, qn = {
            ...
            result: function() {
                var t = [[An, Rn], [kn, Fn]];
                return kn = Fn = -(Rn = An = 1 / 0),
                t
            }
        }, Xn = 0, Yn = 0, Un = 0, Jn = 0, Kn = 0, Qn = 0, $n = 0, ti = 0, ei = 0, ni = {
            point: ii,
            lineStart: ri,
            lineEnd: ui,
            polygonStart: function() {
            ...
            result: function() {
                ...
                return Xn = Yn = Un = Jn = Kn = Qn = $n = ti = ei = 0,
                t
            }
        };
        function ii(t, e) {
        ...
        function fi(t) {
            ...
            point: function(t, e) {
                ...
                default:
                    ...
                    this._context.arc(t, e, this._radius, 0, N)
                }
            },
            result: tt
        };
        var di, gi, vi, mi, yi, bi = new S, Pi = {
            point: tt,
            lineStart: function() {
                Pi.point = _i
            },
        ...
        xi.prototype = {
            ...
            point: function(t, e) {
                ...
                case 1:
                    ...
                    break;
                default:
                    null == this._circle && (this._circle = ji(this._radius)),
                ...
                function n(i, r, o, a, u, s, c, l, h, p, f, d, g, v) {
                    ...
                    if (b > 4 * e && g--) {
                        var P = a + p
                          ...
                          , I = L - r
                          , T = y * C - m * I;
                        (T * T / b > e || A((m * C + y * I) / b - .5) > .3 || a * p + u * f + s * d < zi) && (n(i, r, o, a, u, s, O, L, j, P /= M, _ /= M, S, g, v),
                        v.point(O, L),
                        n(O, L, j, P, _, S, c, l, h, p, f, d, g, v))
                    }
                }
                return function(e) {
                    ...
                    function y(i, r) {
                        var o = Tt([i, r])
                          , a = t(i, r);
                        n(l, h, c, p, f, d, l = a[0], h = a[1], c = i, p = o[0], f = o[1], d = o[2], Ni, e),
                        e.point(l, h)
                    }
                    function b() {
                        g.point = v,
                    ...
                    function S() {
                        n(l, h, c, p, f, d, r, o, i, a, u, s, Ni, e),
                        g.lineEnd = b,
                        b()
                    }
                    return g
        ...
        function Fi(t) {
            var e, n, i, r, o, a, u, s, c, l, h = 150, p = 480, f = 250, d = 0, g = 0, v = 0, m = 0, y = 0, b = 0, P = 1, _ = 1, S = null, M = Ze, x = null, j = Cn, w = .5;
            function O(t) {
            ...
            O.clipAngle = function(t) {
                return arguments.length ? (M = +t ? qe(S = t * V) : (S = null,
                Ze),
                E()) : S * z
            }
            ,
            O.clipExtent = function(t) {
                return arguments.length ? (j = null == t ? (x = i = r = o = null,
                Cn) : Je(x = +t[0][0], i = +t[0][1], r = +t[1][0], o = +t[1][1]),
                E()) : null == x ? null : [[x, i], [r, o]]
            }
            ,
            O.scale = function(t) {
            ...
            ,
            O.center = function(t) {
                return arguments.length ? (d = t[0] % 360 * V,
                g = t[1] % 360 * V,
                C()) : [d * z, g * z]
            }
            ,
            O.rotate = function(t) {
                return arguments.length ? (v = t[0] % 360 * V,
                m = t[1] % 360 * V,
                y = t.length > 2 ? t[2] % 360 * V : 0,
                C()) : [v * z, m * z, y * z]
            }
            ,
            O.angle = function(t) {
                return arguments.length ? (b = t % 360 * V,
                C()) : b * z
            }
            ,
            ...
            O.reflectY = function(t) {
                return arguments.length ? (_ = t ? -1 : 1,
                C()) : _ < 0
            }
            ,
            O.precision = function(t) {
                return arguments.length ? (a = Vi(u, w = t * t),
                E()) : U(w)
            }
            ,
        ...
        function Hi(t, e) {
            ...
            return a.invert = function(t, e) {
                var n = o - e
                  , a = k(t, A(n)) * Y(n);
                return n * i < 0 && (a -= T * Y(t) * Y(n)),
                [a / i, Q((r - (t * t + n * n) * i * i) / (2 * i))]
            }
            ,
            a
        }
        ...
        var qi = function() {
            var t, e, n, i, r, o, a = Zi(), u = Wi().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), s = Wi().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), c = {
                point: function(t, e) {
                    o = [t, e]
                }
            };
            ...
            l.translate = function(t) {
                ...
                var e = a.scale()
                  , o = +t[0]
                  , l = +t[1];
                return n = a.translate(t).clipExtent([[o - .455 * e, l - .238 * e], [o + .455 * e, l + .238 * e]]).stream(c),
                i = u.translate([o - .307 * e, l + .201 * e]).clipExtent([[o - .425 * e + E, l + .12 * e + E], [o - .214 * e - E, l + .234 * e - E]]).stream(c),
                r = s.translate([o - .205 * e, l + .212 * e]).clipExtent([[o - .214 * e + E, l + .166 * e + E], [o - .115 * e - E, l + .234 * e - E]]).stream(c),
                h()
            }
            ,
        ...
        function er(t) {
            var e, n, i, r = ki(t), o = r.center, a = r.scale, u = r.translate, s = r.clipExtent, c = null;
            function l() {
                var o = T * a()
                  , u = r(Ie(r.rotate()).invert([0, 0]));
                return s(null == c ? [[u[0] - o, u[1] - o], [u[0] + o, u[1] + o]] : t === $i ? [[Math.max(u[0] - o, c), e], [Math.min(u[0] + o, n), i]] : [[c, Math.max(u[1] - o, e)], [n, Math.min(u[1] + o, i)]])
            }
            ...
            r.clipExtent = function(t) {
                return arguments.length ? (null == t ? c = e = n = i = null : (c = +t[0][0],
                e = +t[0][1],
                n = +t[1][0],
                i = +t[1][1]),
                l()) : null == c ? null : [[c, e], [n, i]]
            }
            ,
            l()
        }
        ...
        dr.invert = function(t, e) {
            for (var n, i = e, r = i * i, o = r * r * r, a = 0; a < 12 && (o = (r = (i -= n = (i * (cr + lr * r + o * (hr + pr * r)) - e) / (cr + 3 * lr * r + o * (7 * hr + 9 * pr * r))) * i) * r * r,
            !(A(n) < I)); ++a)
                ;
        ...
        var mr = function() {
          ...
          , yr = function() {
            var t, e, n, i, r, o, a, u = 1, s = 0, c = 0, l = 1, h = 1, p = 0, f = null, d = 1, g = 1, v = Li({
                point: function(t, e) {
                    var n = b([t, e]);
            ...
            b.clipExtent = function(t) {
                return arguments.length ? (m = null == t ? (f = n = i = r = null,
                Cn) : Je(f = +t[0][0], n = +t[0][1], i = +t[1][0], r = +t[1][1]),
                y()) : null == f ? null : [[f, n], [i, r]]
            }
            ,
            b.scale = function(t) {
                return arguments.length ? (u = +t,
            ...
            ,
            b.angle = function(n) {
                return arguments.length ? (e = X(p = n % 360 * V),
                t = F(p),
                y()) : p * z
            }
            ,
        ...
        var wr = function() {
          ...
          , Or = function(t) {
            function e() {
                ...
                return e.className = "MapSeriesDataItem",
                e.values.value = {},
                e.applyTheme(),
                e
            }
            ...
            e.prototype.updateExtremes = function() {
                ...
                if (t) {
                    var e = he(t)
                      ...
                      , o = e[1][0]
                      , a = !1;
                    r != this.north && (this._north = v.round(r, 6),
                    a = !0),
                    i != this.south && (this._south = v.round(i, 6),
                    a = !0),
                    o != this.east && (this._east = v.round(o, 6),
                    a = !0),
                    n != this.west && (this._west = v.round(n, 6),
                    a = !0),
                    this._east < this._west && (this._east = 180,
                    this._west = -180),
          ...
          , Lr = function(t) {
            ...
            Object.defineProperty(e.prototype, "geodata", {
                ...
                set: function(t) {
                    if (t != this._geodata) {
                        this._geodata = t,
                        this.reverseGeodata && this.chart.processReverseGeodata(this._geodata);
            ...
            e.prototype.updateExtremes = function() {
                ...
                this.north == t && this.east == n && this.south == e && this.west == i || (this._north = t,
                this._east = n,
                this._west = i,
                this._south = e,
        ...
        d.c.registeredClasses.MapSeries = Lr,
        d.c.registeredClasses.MapSeriesDataItem = Or;
        var Cr = n("C6dT")
          , Er = function(t) {
            function e() {
                var e = t.call(this) || this;
            ...
            e.prototype.validate = function() {
                this.series && this.series.itemReaderText && (this.readerTitle = this.series.itemReaderText),
                ...
                if (t) {
                    ...
                    if (e) {
                        var n = he(e)
                          ...
                          , a = n[1][0]
                          , u = !1;
                        o != this.north && (this._north = v.round(o, 8),
                        u = !0),
                        r != this.south && (this._south = v.round(r),
                        u = !0),
                        a != this.east && (this._east = v.round(a),
                        u = !0),
                        i != this.west && (this._west = v.round(i),
                        u = !0),
                        u && (this.dispatch("geoBoundsChanged"),
            ...
            e.prototype.showTooltip = function(e) {
                ...
                return n && "always" == this.showTooltipOn && !this.series.chart.events.has("mappositionchanged", this.handleTooltipMove, this) && this.addDisposer(this.series.chart.events.on("mappositionchanged", this.handleTooltipMove, this)),
                n
            }
            ,
        ...
        var Ir = function(t) {
            ...
            Object.defineProperty(e.prototype, "latitude", {
                get: function() {
                    ...
                    return !g.isNumber(t) && this.dataItem && this.dataItem.geoPoint && (t = this.dataItem.geoPoint.latitude),
                    t
                },
                set: function(t) {
            ...
            Object.defineProperty(e.prototype, "longitude", {
                get: function() {
                    ...
                    return !g.isNumber(t) && this.dataItem && this.dataItem.geoPoint && (t = this.dataItem.geoPoint.longitude),
                    t
                },
                set: function(t) {
        ...
        var qr = function(t) {
            function e() {
                ...
                e.polygon = e.createChild(Tr.a),
                e.polygon.shouldClone = !1,
                e.polygon.applyOnClones = !0,
                e.setPropertyValue("precision", .5);
                var n = new p.a;
                return e.fill = n.getFor("secondaryButton"),
            ...
            Object.defineProperty(e.prototype, "multiGeoPolygon", {
                get: function() {
                    ...
                    return !t && this.dataItem && (t = this.dataItem.multiGeoPolygon),
                    t
                },
                set: function(t) {
                    this.setPropertyValue("multiGeoPolygon", t, !0),
                    this.multiPolygon = Hr(t)
                },
                enumerable: !0,
                configurable: !0
            }),
            Object.defineProperty(e.prototype, "multiPolygon", {
                get: function() {
                    ...
                    return !t && this.dataItem && (t = this.dataItem.multiPolygon),
                    t
                },
                set: function(t) {
                ...
                if (this.series) {
                    ...
                    if (this.multiPolygon) {
                        if (this.series) {
                            ...
                            e.d3Projection.precision(this.precision),
                        ...
                        if (this.series.calculateVisualCenter) {
                            ...
                            var c = Dr()(o);
                            this._visualLongitude = c[0],
                            this._visualLatitude = c[1]
                        } else
            ...
            e.prototype.copyFrom = function(e) {
                ...
                this.polygon.copyFrom(e.polygon)
            }
            ,
            e.prototype.updateExtremes = function() {
        ...
        var Xr = n("vMqJ")
            ...
            Object.defineProperty(e.prototype, "mapPolygon", {
                get: function() {
                    ...
                    if (!this._mapPolygon) {
                        ...
                        this._mapPolygon = e,
                        this.addSprite(e),
                        this._disposers.push(new h.b(function() {
          ...
          , Kr = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e.calculateVisualCenter = !1,
                ...
                e.setPropertyValue("sortPolygonsBy", "area"),
                e.setPropertyValue("sortPolygonsReversed", !1),
                e.applyTheme(),
                e
            }
            return Object(c.c)(e, t),
            ...
            e.prototype.validateData = function() {
                if (this.useGeodata || this.geodata) {
                    ...
                    if (this.geodata && (e = this.geodata),
                    e) {
                        var n = void 0;
                        ...
                        n)
                            for (var i = function(t, e) {
                                ...
                                if (o) {
                                    var a = o.type
                                      , u = i.id;
                                    if (r.chart.geodataNames && r.chart.geodataNames[u] && (i.properties.name = r.chart.geodataNames[u]),
                                    "Polygon" == a || "MultiPolygon" == a) {
                                        ...
                                        r.data.push(c)),
                                        Yr.softCopyProperties(i.properties, c)
                                    }
                                }
                            }, r = this, o = 0, a = n.length; o < a; o++)
                                i(o)
                    }
                }
                ...
                "none" != this.sortPolygonsBy) {
                    ...
                    this.mapPolygons.sort(function(t, i) {
                        ...
                        case "area":
                            ...
                            break;
                        case "name":
                            r = t.dataItem.dataContext.name || "",
                            o = i.dataItem.dataContext.name || "",
                            a = 1,
                            u = -1;
                            break;
                        case "id":
                            r = t.dataItem.dataContext.id || "",
                            o = i.dataItem.dataContext.id || "",
                            a = 1,
                            u = -1;
                            break;
                        case "latitude":
                    ...
                    this.mapPolygons.each(function(t, e) {
                        t.validate(),
                        t.zIndex || t.propertyFields.zIndex || (t.zIndex = 1e6 - e)
                    })
                }
            }
            ,
            Object.defineProperty(e.prototype, "mapPolygons", {
                get: function() {
                    if (!this._mapPolygons) {
                        var t = new qr
                          , e = new Xr.e(t);
                        this._disposers.push(new Xr.c(e)),
        ...
        d.c.registeredClasses.MapPolygonSeries = Kr,
        d.c.registeredClasses.MapPolygonSeriesDataItem = Jr;
        var Qr = function() {
            function t() {
        ...
        var $r = n("FzPm")
          ...
          , no = function(t) {
            function e() {
                ...
                e.seriesContainer = e.createChild(Cr.a),
            ...
            Object.defineProperty(e.prototype, "series", {
                get: function() {
                    return this._series || (this._series = new Xr.b,
            ...
            e.prototype.updateRectangle = function() {
                var t = this.chart
                  , e = t.zoomLevel
                  , n = this.rectangle;
                n.width = this.pixelWidth / e,
                n.height = this.pixelHeight / e;
        ...
        function ao(t) {
            var e = so(t.longitude)
              ...
              , i = so(t.latitude);
            return Math.abs(i) > 90 && (e = so(e + 180)),
            t.longitude = e,
            t.latitude = n,
            t
        }
        ...
        var ho = function(t) {
            ...
            Object.defineProperty(e.prototype, "geoPoint", {
                ...
                set: function(t) {
                    this._geoPoint = t,
                    this.point = [t.longitude, t.latitude]
                },
                enumerable: !0,
                configurable: !0
            }),
          ...
          , po = function(t) {
            ...
            e.prototype.validateData = function() {
                var e = this;
                if (this.data.length > 0 && 0 == this._parseDataFrom && this.mapImages.clear(),
                        ...
                        for (var r = function(t, e) {
                            ...
                            if (r) {
                                ...
                                if ("Point" == a || "MultiPoint" == a) {
                                    if (!o.checkInclude(o.include, o.exclude, u))
                                        return "continue";
                                    var s = r.coordinates;
                                    "Point" == a && (s = [s]);
                                    ...
                                    o.data.push(c)),
                                    Yr.softCopyProperties(n.properties, c)
                                }
                            }
                        }, o = this, a = 0, u = i.length; a < u; a++)
                            r(a)
                }
                t.prototype.validateData.call(this),
                Ur.each(this.dataItems.iterator(), function(t) {
                    var n = t.mapImage;
                    n.isDisposed() || (e.mapImages.moveValue(n),
                    g.isNumber(n.latitude) && g.isNumber(n.latitude) && (t.geoPoint = {
                        latitude: n.latitude,
            ...
            e.prototype.validate = function() {
                t.prototype.validate.call(this),
                Ur.each(this.mapImages.iterator(), function(t) {
                    t.validatePosition()
                })
            }
            ,
        ...
        d.c.registeredClasses.MapImageSeries = po,
        d.c.registeredClasses.MapImageSeriesDataItem = ho;
        var fo = n("Rnbi")
          , go = n("jfaP")
          , vo = n("tjMS")
          , mo = function(t) {
            function e() {
                ...
                e.className = "MapLine",
                e.createLine(),
                e.line.stroke = Object(eo.c)(),
                e.line.parent = e,
                e.strokeOpacity = 1,
                e.setPropertyValue("precision", .1);
                var n = new p.a;
                return e.stroke = n.getFor("grid"),
            ...
            Object.defineProperty(e.prototype, "multiGeoLine", {
                get: function() {
                    ...
                    return !t && this.dataItem && this.dataItem.multiGeoLine && (t = this.dataItem.multiGeoLine),
                    t
                },
                set: function(t) {
                    if (t && t.length > 0) {
                        ...
                        var e = Br(t);
                        this.setPropertyValue("multiLine", e),
                        this.updateExtremes()
                    }
                },
                enumerable: !0,
            ...
            Object.defineProperty(e.prototype, "multiLine", {
                get: function() {
                    ...
                    return !t && this.dataItem && this.dataItem.multiLine && (t = this.dataItem.multiLine),
                    t
                },
                set: function(t) {
                    this.setPropertyValue("multiLine", t),
                    this.multiGeoLine = Vr(t)
                },
                enumerable: !0,
                configurable: !0
            }),
            Object.defineProperty(e.prototype, "imagesToConnect", {
                ...
                set: function(t) {
                    var e = this;
                    if (this.setPropertyValue("imagesToConnect", t, !0),
                      ...
                      , o = function(t) {
                        ...
                        !a._imageListeners[t.uid])) {
                            var r = t.events.on("propertychanged", function(t) {
                                "longitude" != t.property && "latitude" != t.property || (n.handleImagesToConnect(),
                                n.invalidate())
                            }, a, !1);
                            a._imageListeners[t.uid] = r,
                            a._disposers.push(r)
                        }
                    }
                      , a = this;
            ...
            e.prototype.validate = function() {
                ...
                if (this.multiLine) {
                    if (this.shortestDistance)
                        e.projection.d3Projection.precision(this.precision),
                    ...
                    Ur.each(this.lineObjects.iterator(), function(t) {
                        t.validatePosition()
                    }),
                    this.handleGlobalScale()
                } else
                    this.imagesToConnect && this.handleImagesToConnect();
                t.prototype.validate.call(this)
            }
            ,
            e.prototype.getFeature = function() {
            ...
            Object.defineProperty(e.prototype, "lineObjects", {
                get: function() {
                    return this._lineObjects || (this._lineObjects = new Xr.e(new lo),
                    this._lineObjects.events.on("inserted", this.handleLineObjectAdded, this, !1),
                    this._disposers.push(new Xr.c(this._lineObjects)),
            ...
            Object.defineProperty(e.prototype, "arrow", {
                get: function() {
                    if (!this._arrow) {
                        ...
                        e.fillOpacity = 1,
                        e.width = Object(vo.c)(100),
                        e.height = Object(vo.c)(100),
                        e.rotation = 90,
            ...
            e.prototype.getTooltipX = function() {
                ...
                return t instanceof vo.a || (t = Object(vo.c)(50)),
                t instanceof vo.a ? this.positionToPoint(t.value).x : 0
            }
            ,
            e.prototype.getTooltipY = function() {
                var t = this.getPropertyValue("tooltipY");
                return t instanceof vo.a || (t = Object(vo.c)(50)),
                t instanceof vo.a ? this.positionToPoint(t.value).y : 0
            }
            ,
            Object.defineProperty(e.prototype, "precision", {
                get: function() {
        ...
        d.c.registeredClasses.MapLineSeries = bo,
        d.c.registeredClasses.MapLineSeriesDataItem = yo;
        var Po = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e.className = "Graticule",
                e.applyTheme(),
                e.shortestDistance = !0,
                e
            }
        ...
        var _o = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e.className = "GraticuleSeriesDataItem",
                e.applyTheme(),
                e
            }
            return Object(c.c)(e, t),
          ...
          , So = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e.className = "GraticuleSeries",
                e.longitudeStep = 10,
                e.latitudeStep = 10,
                e.north = 90,
                e.south = -90,
                ...
                e.mapLines.template.line.strokeOpacity = .08,
                e.ignoreBounds = !1,
                e.hiddenInLegend = !0,
                e.applyTheme(),
                e
            ...
            e.prototype.validateData = function() {
                ...
                var n = Sn();
                if (n) {
                    n.stepMinor([this.longitudeStep, this.latitudeStep]),
                    n.stepMajor([360, 360]);
                    var i = this.chart;
                    if (this.fitExtent ? n.extent([[i.east, i.north], [i.west, i.south]]) : n.extent([[this.east, this.north], [this.west, this.south]]),
                    this.singleSprite) {
        ...
        d.c.registeredClasses.GraticuleSeries = So,
        d.c.registeredClasses.GraticuleSeriesDataItem = _o;
        var Mo = n("zhwk")
          , xo = function(t) {
            function e() {
                var e = t.call(this) || this;
          ...
          , jo = function(t) {
            function e() {
                ...
                e.projection = new Qr,
                e.setPropertyValue("deltaLatitude", 0),
                e.setPropertyValue("deltaLongitude", 0),
                e.setPropertyValue("deltaGamma", 0),
                e.maxPanOut = .7,
                e.homeZoomLevel = 1,
                e.zoomStep = 2,
                e.layout = "absolute",
                ...
                n.zIndex = 0,
                n.dragWhileResize = !0,
                n.adapter.add("scale", function(t, n) {
                    return v.fitToRange(t, e.minZoomLevel, e.maxZoomLevel)
                }),
                e.events.on("maxsizechanged", function(t) {
                    0 != t.previousWidth && 0 != t.previousHeight || (e.updateExtremes(),
                    e.updateCenterGeoPoint())
                }, void 0, !1);
                var i = e.chartContainer;
                i.parent = e,
                i.zIndex = -1,
                e._disposers.push(e.events.on("maxsizechanged", function() {
                    if (e.inited) {
            ...
            e.prototype.handlePanDown = function(t) {
                ...
                e.x > 0 && e.y > 0 && e.x < this.svgContainer.width && e.y < this.svgContainer.height && (this._downPointOrig = Yr.documentPointToSprite(t.pointer.point, this.seriesContainer),
            ...
            e.prototype.handlePanUp = function(t) {
                this._downPointOrig && this.panSprite.dragStop(t.pointer, !0),
                this._downPointOrig = void 0
            }
            ,
            e.prototype.handlePanMove = function() {
                if (!this.seriesContainer.isResized) {
                    if (Object(Mo.b)().areTransformed([this.panSprite.interactions, this.seriesContainer.interactions]))
                        return;
                    ...
                    if ("move" != e && "none" != e && this._downPointOrig && t.rotate) {
                        ...
                        t.rotate([i, r, o]),
                        s && ("rotateLat" != e && "rotateLongLat" != e || (this.deltaLatitude = this._downDeltaLatitude + s.latitude - a.latitude),
                        "rotateLong" != e && "rotateLongLat" != e || (this.deltaLongitude = this._downDeltaLongitude + s.longitude - a.longitude))
                    }
                }
            }
            ,
            e.prototype.handleAllInited = function() {
                var t = this
                  , e = !0;
                if (this.seriesContainer.visible = !0,
            ...
            e.prototype.updateCenterGeoPoint = function() {
                ...
                this.seriesWidth > 0 && this.seriesHeight > 0 ? (this.chartContainer.visible = !0,
            ...
            e.prototype.applyInternalDefaults = function() {
                ...
                g.hasValue(this.background.readerTitle) || (this.background.readerTitle = this.language.translate("Use plus and minus keys on your keyboard to zoom in and out"))
            }
            ,
            ...
            Object.defineProperty(e.prototype, "panBehavior", {
                ...
                set: function(t) {
                    if (this.setPropertyValue("panBehavior", t)) {
                        ...
                        switch (this.panSprite.draggable = !1,
                        e.draggable = !1,
                        t) {
                        case "move":
                            e.draggable = !0;
            ...
            Object.defineProperty(e.prototype, "projection", {
                ...
                set: function(t) {
                    ...
                    this.inited && this.updateExtremes(),
                    this.series.each(function(t) {
            ...
            e.prototype.updateExtremes = function() {
                var t, e, n, i;
                this.series.each(function(r) {
                    r.ignoreBounds || r instanceof So && r.fitExtent || ((r.north > e || !g.isNumber(e)) && (e = r.north),
                ...
                var r = []
                  , o = !1;
                this.series.each(function(t) {
                    t instanceof So && !t.fitExtent && (r = t.getFeatures(),
                    o = !0)
                }),
                ...
                if (r.length > 0 && s && (this.east != t || this.west != n || this.north != e || this.south != i)) {
                    ...
                    s.rotate) {
                        var c = s.rotate()
                          ...
                          , h = c[1]
                          , p = c[2];
                        this.deltaLongitude = l,
                        this.deltaLatitude = h,
                        this.deltaGamma = p
                    }
                    var f = {
            ...
            e.prototype.updateScaleRatio = function() {
                ...
                Ur.each(this.series.iterator(), function(e) {
                    e.scale = t,
                    e.updateTooltipBounds()
                }),
            ...
            Object.defineProperty(e.prototype, "geodata", {
                ...
                set: function(t) {
                    ...
                    this.reverseGeodata && this.processReverseGeodata(this._geodata),
                    this.invalidateData(),
                ...
                for (var e = 0; e < t.features.length; e++)
                    for (var n = t.features[e], i = 0; i < n.geometry.coordinates.length; i++)
                        if ("MultiPolygon" == n.geometry.type)
                            for (var r = 0; r < n.geometry.coordinates[i].length; r++)
                                n.geometry.coordinates[i][r].reverse();
                        else
                            n.geometry.coordinates[i].reverse()
            }
            ,
            e.prototype.zoomToGeoPoint = function(t, e, n, i, r) {
                ...
                if (t && g.isNumber(t.longitude) && g.isNumber(t.latitude)) {
                    ...
                    if (u) {
                        ...
                        return !r && e < this.zoomLevel && this.centerMapOnZoomOut && e < 1.5 && (l = this.innerWidth / 2 - (this.seriesMaxLeft + (this.seriesMaxRight - this.seriesMaxLeft) / 2) * e * this.scaleRatio,
                        h = this.innerHeight / 2 - (this.seriesMaxTop + (this.seriesMaxBottom - this.seriesMaxTop) / 2) * e * this.scaleRatio),
            ...
            e.prototype.zoomToMapObject = function(t, e, n, i) {
                ...
                var o = t.dataItem;
                if (o && g.isNumber(o.zoomLevel) && (e = o.zoomLevel),
                t instanceof qr) {
                    var a = t.dataItem
                      , u = t.polygon.bbox;
                    0 != u.width && 0 != u.height || (u = t.polygon.group.getBBox()),
                    g.isNumber(e) || (e = Math.min(this.seriesWidth / u.width, this.seriesHeight / u.height));
                    var s = void 0;
                    if (a && g.hasValue(a.zoomGeoPoint))
                        s = a.zoomGeoPoint;
                    else {
                        var c = {
                            x: u.x + u.width / 2,
            ...
            e.prototype.zoomIn = function(t, e, n) {
                ...
                return i < 1 && (i = 1),
                this.zoomToGeoPoint(t, this.zoomLevel * i, !1, e)
            }
            ,
            ...
            e.prototype.handleMapTransform = function() {
                ...
                this.svgContainer.readerAlert(this.language.translate("Zoom level changed to %1", this.language.locale, g.castString(this.zoomLevel)))),
            ...
            Object.defineProperty(e.prototype, "deltaLongitude", {
                ...
                set: function(t) {
                    t = v.round(t, 3),
                    this.setPropertyValue("deltaLongitude", so(t)) && (this.rotateMap(),
            ...
            Object.defineProperty(e.prototype, "deltaLatitude", {
                ...
                set: function(t) {
                    t = v.round(t, 3),
                    this.setPropertyValue("deltaLatitude", t) && (this.rotateMap(),
                    this.updateZoomGeoPoint())
                },
                enumerable: !0,
                configurable: !0
            ...
            Object.defineProperty(e.prototype, "deltaGamma", {
                ...
                set: function(t) {
                    t = v.round(t, 3),
                    this.setPropertyValue("deltaGamma", t) && (this.rotateMap(),
                    this.updateZoomGeoPoint())
                },
                enumerable: !0,
                configurable: !0
            ...
            e.prototype.rotateMap = function() {
                this.projection.d3Projection && this.projection.d3Projection.rotate && (this.projection.d3Projection.rotate([this.deltaLongitude, this.deltaLatitude, this.deltaGamma]),
            ...
            e.prototype.handleSeriesAdded = function(e) {
                ...
                var n = e.newValue;
                n.scale = this.scaleRatio,
                n.events.on("validated", this.updateCenterGeoPoint, this, !1)
            }
            ,
            ...
            e.prototype.goHome = function(t) {
                ...
                e && this.zoomToGeoPoint(e, this.homeZoomLevel, !0, t, !0)
            }
            ,
            ...
            Object.defineProperty(e.prototype, "backgroundSeries", {
                get: function() {
                    ...
                    if (!this._backgroundSeries) {
                        ...
                        e.chart = this,
                        e.hiddenInLegend = !0,
                        e.mapPolygons.template.focusable = !1,
                        e.addDisposer(new h.b(function() {
            ...
            e.prototype.hasLicense = function() {
                if (ro.a.commercialLicense)
                    return !0;
                if (!t.prototype.hasLicense.call(this))
                    return !1;
                for (var e = 0; e < ro.a.licenses.length; e++)
                    if (ro.a.licenses[e].match(/^MP.{5,}/i))
                        return !0;
                return !1
            }
            ,
        ...
        d.c.registeredClasses.MapSplineSeries = Io,
        d.c.registeredClasses.MapSplineSeriesDataItem = Eo;
        var To = function(t) {
            function e() {
                var e = t.call(this) || this;
        ...
        d.c.registeredClasses.MapArcSeries = Go,
        d.c.registeredClasses.MapArcSeriesDataItem = To;
        var Do = n("aGXA")
          , No = n("CnhP")
          , zo = function(t) {
            function e() {
            ...
            e.prototype.fixLayout = function() {
                ...
                e.width = Object(vo.c)(100),
                e.height = void 0,
                n.width = Object(vo.c)(100),
                n.height = void 0,
                t.width = Object(vo.c)(100),
                t.height = void 0,
                i.width = Object(vo.c)(100),
                e.marginTop = 1,
                t.marginBottom = 2,
                i.height = 0,
                e.toFront(),
                ...
                n.minX = 0,
                n.maxX = 0,
                n.minY = 0) : "horizontal" == this.layout && (this.height = 40,
                this.width = void 0,
                e.height = Object(vo.c)(100),
                e.width = void 0,
                t.height = Object(vo.c)(100),
                t.width = void 0,
                n.height = Object(vo.c)(100),
                n.width = void 0,
                n.minX = 0,
                n.minY = 0,
                n.maxY = 0,
                i.height = Object(vo.c)(100),
                i.width = 0,
                e.toBack(),
                t.toFront())
            }
            ...
            e.prototype.handleThumbDrag = function() {
                var t, e = this.slider, n = this.chart, i = this.thumb;
        ...
        fa.invert = function(t, e) {
            if (!(t * t + 4 * e * e > $o * $o + Ko)) {
                var n = t
                  ...
                  , r = 25;
                do {
                    var o, a = Uo(n), u = Uo(n / 2), s = Fo(n / 2), c = Uo(i), l = Fo(i), h = Uo(2 * i), p = c * c, f = l * l, d = u * u, g = 1 - f * s * s, v = g ? ca(l * s) * la(o = 1 / g) : o = 0, m = 2 * v * l * u - t, y = v * c - e, b = o * (f * d + v * l * s * p), P = o * (.5 * a * h - 2 * v * c * u), _ = .25 * o * (h * u - v * c * f * a), S = o * (p * s + v * d * l), M = P * _ - S * b;
                    if (!M)
                        break;
                    var x = (y * P - m * S) / M
                      , j = (m * _ - y * b) / M;
        ...
        ja.invert = function(t, e) {
            var n, i, r = Ma * e, o = e < 0 ? -ea : ea, a = 25;
            do {
                i = r - ia * Uo(o),
                o -= n = (Uo(2 * o) + 2 * o - $o * Uo(i)) / (2 * Fo(2 * o) + 2 + $o * Fo(i) * ia * Fo(o))
            } while (Ao(n) > Ko && --a > 0);
            return i = r - ia * Uo(o),
            [t * (1 / Fo(i) + xa / Fo(o)) / Ma, i]
        }
        ;
        function wa(t, e) {
            return [t * Fo(e), e]
        ...
        ;
        function za(t, e) {
            for (var n = (1 + ta) * Uo(e), i = 0, r = 1 / 0; i < 10 && Ao(r) > Ko; i++)
                e -= r = (e + Uo(e) - n) / (1 + Fo(e));
            return n = la(2 + $o),
            [t * (1 + Fo(e)) / n, 2 * e / n]
        }
        ...
        Ra.invert = function(t, e) {
            if (!(n = da.invert(t / 1.2, 1.065 * e)))
                return null;
            var n, i = n[0], r = n[1], o = 20;
            t /= Aa,
            e /= Aa;
            do {
                var a = i / 2
        ...
        Ha(2.8284, -1.6988, .75432, -.18071, 1.76003, -.38914, .042555),
        Ha(2.583819, -.835827, .170354, -.038094, 1.543313, -.411435, .082742),
        ...
        function Za(t, e) {
            ...
            var s = function(t, e) {
                if (e === ta)
                    return [0, 0];
                var n, i, r = Uo(e), o = r * r, a = o * o, u = 1 + a, s = 1 + 3 * a, c = 1 - a, l = sa(1 / la(u)), h = c + o * u * l, p = (1 - r) / h, f = la(p), d = p * u, g = la(d), v = f * c;
                if (0 === t)
                    return [0, -(v + o * g)];
                var m, y = Fo(e), b = 1 / y, P = 2 * r * y, _ = (-h * y - (-3 * o + l * s) * P * (1 - r)) / (h * h), S = -b * P, M = -b * (o * u * _ + p * s * P), x = -2 * b * (c * (.5 * _ / f) - 2 * o * f * P), j = 4 * t / $o;
                if (t > .222 * $o || e < $o / 4 && t > .175 * $o) {
                    if (n = (v + o * la(d * (1 + a) - v * v)) / (1 + a),
                    t > $o / 4)
                        return [n, n];
                    var w = n
                      , O = .5 * n;
        ...
        Za.invert = function(t, e) {
            ...
            var n = Yo(t)
              ...
              , u = function(t, e) {
                ...
                return [$o / 4 * (t * (-2 * b * (.5 * _ / h * (1 - a) - 2 * r * h * P) + -b * P * g) + -b * (r * (1 + a) * _ + l * (1 + 3 * a) * P) * sa(t / la(p))), m]
            }(a ? o : r, a ? r : o)
              , s = u[0]
              , c = u[1]
              , l = Fo(c);
            return a && (s = -ta - s),
            [n * (ko(Uo(s) * l, -Uo(c)) + $o), i * sa(Fo(s) * l)]
        }
        ;
        function qa(t, e) {
            var n, i, r, o, a;
            if (e < Ko)
                return [(o = Uo(t)) - (n = e * (t - o * (i = Fo(t))) / 4) * i, i + n * o, 1 - e * o * o / 2, t - n];
            if (e >= 1 - Ko)
                return n = (1 - e) / 4,
                r = 1 / (i = pa(t)),
                [(o = function(t) {
                    return ((t = Bo(2 * t)) - 1) / (t + 1)
                }(t)) + n * ((a = i * ha(t)) - t) / (i * i), r - n * o * r * (a - t), r + n * o * r * (a + t), 2 * Ro(Bo(t)) - ta + n * (a - t) / i];
            var u = [1, 0, 0, 0, 0, 0, 0, 0, 0]
              , s = [la(e), 0, 0, 0, 0, 0, 0, 0, 0]
              , c = 0;
            for (i = la(1 - e),
            a = 1; Ao(s[c] / u[c]) > Ko && c < 8; )
                n = u[c++],
                s[c] = (n - i) / 2,
                u[c] = (n + i) / 2,
                i = la(n * i),
        ...
        Ya.invert = function(t, e) {
            var n = (ia - 1) / (ia + 1)
              ...
              , r = function(t, e, n) {
                var i, r, o;
                return t ? (i = qa(t, n),
                e ? (o = (r = qa(e, 1 - n))[1] * r[1] + n * i[0] * i[0] * r[0] * r[0],
                [[i[0] * r[2] / o, i[1] * i[2] * r[0] * r[1] / o], [i[1] * r[1] / o, -i[0] * i[2] * r[0] * r[2] / o], [i[2] * r[1] * r[2] / o, -n * i[0] * i[1] * r[0] / o]]) : [[i[0], 0], [i[1], 0], [i[2], 0]]) : [[0, (r = qa(e, 1 - n))[0] / r[1]], [1 / r[1], 0], [r[2] / r[1], 0]]
            }(.5 * Xa(ta, i * i) - e, -t, i * i)
              , o = function(t, e) {
        ...
        ;
        function Qa(t, e) {
            return Ao(e) > Ua ? ((t = Sa(t, e))[1] -= e > 0 ? Ja : -Ja,
            t) : wa(t, e)
        }
        ...
        ;
        function cu(t, e) {
            for (var n, i = (1 + na) * Uo(e), r = e, o = 0; o < 25 && (r -= n = (Uo(r / 2) + Uo(r) - i) / (.5 * Fo(r / 2) + Fo(r)),
            !(Ao(n) < Ko)); o++)
                ;
        ...
        lu.invert = function(t, e) {
            var n = la(6 / (4 + $o))
              , i = e / n;
            return Ao(Ao(i) - ta) < Ko && (i = i < 0 ? -ta : ta),
            [1.5 * t / (n * (.5 + Fo(i))), sa((i / 2 + Uo(i)) / (1 + $o / 4))]
        }
        ;
        function hu(t, e) {
            var n = e * e
        ...
        Mu.invert = function(t, e) {
            ...
            return a = Jo(r),
            [(Ao(e) < Ao(r + 1 / a) ? sa(t * a) : Yo(e) * Yo(t) * (ca(Ao(t * a)) + ta)) / Uo(r), r]
        }
        ;
        var xu = [[0, 90], [-90, 0], [0, 0], [90, 0], [180, 0], [0, -90]]
          , ju = ([[0, 2, 1], [0, 3, 2], [5, 1, 2], [5, 2, 3], [0, 1, 4], [0, 4, 3], [5, 4, 1], [5, 3, 4]].map(function(t) {
        ...
        ;
        var Ou = [[.9986, -.062], [1, 0], [.9986, .062], [.9954, .124], [.99, .186], [.9822, .248], [.973, .31], [.96, .372], [.9427, .434], [.9216, .4958], [.8962, .5571], [.8679, .6176], [.835, .6769], [.7986, .7346], [.7597, .7903], [.7186, .8435], [.6732, .8936], [.6213, .9394], [.5722, .9761], [.5322, 1]];
        function Lu(t, e) {
            var n, i = qo(18, 36 * Ao(e) / $o), r = Ho(i), o = i - r, a = (n = Ou[r])[0], u = n[1], s = (n = Ou[++r])[0], c = n[1], l = (n = Ou[qo(19, ++r)])[0], h = n[1];
            return [t * (s + o * (l - a) / 2 + o * o * (l - 2 * s + a) / 2), (e > 0 ? ta : -ta) * (c + o * (h - u) / 2 + o * o * (h - 2 * c + u) / 2)]
        }
        ...
        Lu.invert = function(t, e) {
            ...
            do {
                ...
                if (f >= 0 || 1 === o) {
                    ...
                    var d, g = 50;
                    do {
                        f = (r = qo(18, Ao(i) / 5)) - (o = Ho(r)),
                        a = Ou[o][1],
                        u = Ou[o + 1][1],
                        s = Ou[qo(19, o + 2)][1],
                        i -= (d = (e >= 0 ? ta : -ta) * (u + f * (s - a) / 2 + f * f * (s - 2 * u + a) / 2) - e) * aa
                    } while (Ao(d) > Qo && --g > 0);
                    break
                }
            } while (--o >= 0);
        ...
        function Eu(t, e) {
            ...
            var n = Ao(e / ta)
              , i = sa(n);
            if (Ao(t) < Ko || Ao(Ao(e) - ta) < Ko)
                return [0, Yo(e) * $o * Jo(i / 2)];
            var r = Fo(i)
              , o = Ao($o / t - t / $o) / 2
              , a = o * o
              , u = r / (n + r - 1)
        ...
        Au.invert = function(t, e) {
            var n = t
              ...
              , r = 25;
            do {
                var o, a = Fo(i), u = Uo(i), s = Uo(2 * i), c = u * u, l = a * a, h = Uo(n), p = Fo(n / 2), f = Uo(n / 2), d = f * f, g = 1 - l * p * p, v = g ? ca(a * p) * la(o = 1 / g) : o = 0, m = .5 * (2 * v * a * f + n / ta) - t, y = .5 * (v * u + i) - e, b = .5 * o * (l * d + v * a * p * c) + .5 / ta, P = o * (h * s / 4 - v * u * f), _ = .125 * o * (s * f - v * u * l * h), S = .5 * o * (c * p + v * d * a) + .5, M = P * _ - S * b, x = (y * P - m * S) / M, j = (m * _ - y * b) / M;
                n -= x,
                i -= j
            } while ((Ao(x) > Ko || Ao(j) > Ko) && --r > 0);
            return [n, i]
        ...
        var Xu = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e.d3Projection = gr(),
                e
            }
            return Object(c.c)(e, t),
            e
        }(Qr);
        d.c.registeredClasses.EqualEarth = Xu,
        window.am4maps = a
    },
    QaCB: function(t, e, n) {
        "use strict";
                ...
                value: function(t) {
                    for (var e = this.data, n = this.compare, i = this.length >> 1, r = e[t]; t < i; ) {
                        var o = 1 + (t << 1)
                          , a = e[o]
                          , u = o + 1;
                        if (u < this.length && n(e[u], a) < 0 && (o = u,
                        a = e[u]),
                        n(a, r) >= 0)
                            break;
                        e[t] = a,
    ...
    "o+vr": function(t, e, n) {
        ...
        function r(t, e, n) {
            ...
            for (var S = m.length; m.length; ) {
                var M = m.pop();
                M.d > P.d && (P = M,
                n && console.log("found best %d after %d probes", Math.round(1e4 * M.d) / 1e4, S)),
                M.max - P.d <= e || (g = M.h / 2,
                m.push(new a(M.x - g,M.y - g,g,t)),
                m.push(new a(M.x + g,M.y - g,g,t)),
                m.push(new a(M.x - g,M.y + g,g,t)),
                m.push(new a(M.x + g,M.y + g,g,t)),
                S += 4)
            }
            n && (console.log("num probes: " + S),
            console.log("best distance: " + P.d));
            var x = [P.x, P.y];
            return x.distance = P.d,
            x
        }
        function o(t, e) {
            return e.max - t.max
