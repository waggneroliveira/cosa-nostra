                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">secao servicos</li>
                                </ol>
                            </div>
                            <h4 class="page-title">secao servicos</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                                ...
                                <div class="row mb-2">
                                    <div class="col-12 d-flex justify-end">
                                        <div class="col-12 d-flex justify-content-end">
                                            @if (Auth::user()->can('secao servicos.visualizar') &&
                                            Auth::user()->can('secao servicos.criar') ||
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="d-flex gap-lg-1 justify-center">
                                                        @if (Auth::user()->can('secao servicos.visualizar') &&
                                                        Auth::user()->can('secao servicos.editar') ||
                                                        Auth::user()->can('usuario.tornar usuario master') || 
                                                        Auth::user()->hasRole('Super'))
                                                            ...
                                                            <div class="modal fade" id="modal-group-edit-{{$statute->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered" style="max-width: 980px;">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-light">
                                                                            <h4 class="modal-title" id="myCenterModalLabel">secao servicos</h4>
                                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                                                                        </div>
                                                                        <div class="modal-body  p-2 px-3 px-md-4">
                                                        ...
                                                        @if (Auth::user()->can('secao servicos.visualizar') &&
                                                        Auth::user()->can('secao servicos.remover') ||
                                                        Auth::user()->can('usuario.tornar usuario master') || 
                                                        Auth::user()->hasRole('Super'))
