                                ...
                                <div class="row mb-2">
                                    <div class="col-12 d-flex justify-end">
                                        <div class="col-12 d-flex justify-content-end">
                                            @if (Auth::user()->can('secao depoimento.visualizar') &&
                                            Auth::user()->can('secao depoimento.criar') ||
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body p-2 px-3 px-md-4">
                                                                <form action="{{ route('admin.dashboard.report.store') }}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    @include('admin.blades.report.form')  
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="d-flex gap-lg-1 justify-center">
                                                        @if (Auth::user()->can('secao depoimento.visualizar') &&
                                                        Auth::user()->can('secao depoimento.editar') ||
                                                        Auth::user()->can('usuario.tornar usuario master') || 
                                                        Auth::user()->hasRole('Super'))
                                                        ...
                                                        @if (Auth::user()->can('secao depoimento.visualizar') &&
                                                        Auth::user()->can('secao depoimento.remover') ||
                                                        Auth::user()->can('usuario.tornar usuario master') || 
                                                        Auth::user()->hasRole('Super'))
