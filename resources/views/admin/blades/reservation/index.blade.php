                                            ...
                                            <tr data-code="{{$reservation->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    @if ($reservation && $reservation->created_at)
                                                        @if (array_key_exists($locale, $locales))
                                                            {{$reservation->created_at->format($locales[$locale])}}
                                                            @else
                                                ...
                                                <td class="d-flex flex-row gap-2">
                                                    @if (Auth::user()->hasRole('Super') || Auth::user()->can('usuario.tornar usuario master') || Auth::user()->can(['grupo.visualizar', 'grupo.editar']))                                                        
                                                        <button data-bs-toggle="modal" data-bs-target="#reservation-edit-{{$reservation->id}}" class="tabledit-edit-button btn btn-primary text-black" style="padding: 2px 8px;width: 30px"><span class="mdi mdi-eye"></span></button>
                                                    @endif
                                                    <div class="modal fade" id="reservation-edit-{{$reservation->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" style="max-width: 760px">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-light">
