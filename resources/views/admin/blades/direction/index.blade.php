                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-12 d-flex justify-between">
                                        <div class="col-6">
                                            @if (Auth::user()->can('a direcao.visualizar') &&
                                            Auth::user()->can('a direcao.remover') ||
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body p-4">
                                                                <form action="{{route('admin.dashboard.direction.store')}}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    @include('admin.blades.direction.form')  
                                            ...
                                            @foreach ($directions as $key => $direction)
                                                <tr data-code="{{$direction->id}}">
                                                    ...
                                                    <td class="d-flex gap-lg-1 justify-center">
                                                        @if (Auth::user()->can('a direcao.visualizar') &&
                                                        Auth::user()->can('a direcao.editar') ||
                                                        Auth::user()->can('usuario.tornar usuario master') || 
                                                        Auth::user()->hasRole('Super'))
