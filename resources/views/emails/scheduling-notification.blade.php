...
<head>
    ...
    <title>Solicitação de agendamento de reserva</title>
</head>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2" style="padding: 35px;background-image: url('{{ asset('build/admin/images/bg-transparente.png') }}'); background-position: top center; background-repeat: no-repeat; background-size: cover;">
                    <h1 style="color: #10131C; font-size: 24px; margin: 0 0 20px; text-align: center;">Solicitação de agendamento de reserva</h1>
                    <p style="color: #555; font-size: 16px; line-height: 1.5; margin-bottom: 20px;">
                        Olá, {{ $name }}
                    </p>

                    <p style="color: #555; font-size: 16px; line-height: 1.5; margin-bottom: 20px;">
                        Recebemos sua solicitação de reserva para o dia <strong>{{ $date }}</strong> às <strong>{{ $hour }}</strong>.
                    </p>

                    <p style="color: #555; font-size: 16px; line-height: 1.5; margin-bottom: 20px;">
                        Número de pessoas: <strong>{{ $people }}</strong>
                    </p>
